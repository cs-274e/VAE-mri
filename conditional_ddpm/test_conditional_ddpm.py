...
# Path to test split (subject folders with T1.nii.gz, T2.nii.gz)
TEST_ROOT = "dataset/test"

# Path to the checkpoint you want to evaluate
# e.g. "checkpoints_cond_t1_to_t2/epoch_100.pth" or "checkpoints_cond_t1_to_t2/best.pth"
CKPT_PATH = "conditional_ddpm/best_models/ddpm_cond_t1_to_t2_2.pth"

# Image size that model was trained on (128 or 192)
IMAGE_SIZE = 128  # change to 192 for your 192x192 model

# Batch size for evaluation (does not affect correctness, just speed/memory)
BATCH_SIZE = 128

# Where to save example PNGs
OUT_DIR = "conditional_ddpm/eval_outputs_128"
...
class PairedNiftiSliceDataset(Dataset):
    ...
    def __init__(
        ...
        for subj_idx, subj_dir in enumerate(self.subjects):
            ...
            # Decide which slices to keep based on T2 non-zero content
